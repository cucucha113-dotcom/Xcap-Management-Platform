...
![Video navigate qua Campaigns, Ad Sets, Ads, Column Presets](assets/fb_full_walkthrough.webp)

### Billing Hub (Payment Activity → Payment Methods)
![Video navigate Billing: Transaction History + Payment Methods](assets/fb_billing_walkthrough.webp)
